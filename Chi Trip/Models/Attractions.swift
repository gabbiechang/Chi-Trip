...
var listOfAttractions = [
    ...
    Attraction(
        ...
        tinyDescription: "One of the oldest art museums in the United States.",
    ...
    Attraction(
        ...
        tinyDescription: "A large greenhouse conservatory with exotic species.",
    ...
    Attraction(
        ...
        tinyDescription: "A free admission zoo with over 1,100 animals.",
    ...
    Attraction(
        ...
        tinyDescription: "A scenic pedestrian waterfront along the Chicago River.",
    ...
    Attraction(
        ...
        tinyDescription: "An art museum with individually curated exhibitions.",
    ...
    Attraction(
        ...
        tinyDescription: "An indoor public aquarium containing various marine life.",
    ...
    Attraction(
        ...
        tinyDescription: "A science and technology museum with historical exhibits.",
    ...
    Attraction(
        ...
        tinyDescription: "A museum featuring Mexican, Latino, and Chicano art.",
    ...
    Attraction(
        ...
        tinyDescription: "The highest observation deck in the US on the 103rd floor.",
    ...
    Attraction(
        ...
        tinyDescription: "The nation’s first free municipal cultural center.",
    ...
    Attraction(
        ...
        tinyDescription: "A museum exploring both Chicago and American history.",
    ...
    Attraction(
        ...
        tinyDescription: "A park in a predominantly Puerto Rican neighborhood.",
    ...
    Attraction(
        ...
        tinyDescription: "One of the largest and most impressive fountains in the world.",
    ...
    Attraction(
        ...
        tinyDescription: "Chicago’s largest upscale shopping district.",
